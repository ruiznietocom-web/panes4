...
const OrderSummary = ({ cartItems, onSendWhatsApp, onRemoveItem }) => {
  ...
  const [customerNote, setCustomerNote] = React.useState(""); // ✅ NUEVO
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3 mb-6">
        {/* ... (todo tu bloque anterior sin cambios) ... */}
      </div>

      {/* ✅ CAMPO PARA NOTA DEL CLIENTE */}
      <div className="mt-6 mb-4">
        <p className="font-semibold text-gray-700 mb-2">✏️ Escribe cualquier petición sobre el pedido:</p>
        <textarea
          value={customerNote}
          onChange={(e) => setCustomerNote(e.target.value)}
          placeholder="Ejemplo: Quiero el pan más tostado, sin cortar..."
