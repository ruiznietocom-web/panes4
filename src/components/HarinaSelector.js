  ...
  return (
    ...
    >
      ...
      <p className="text-gray-500 text-center mb-4">
        Puedes seleccionar hasta {maxHarinas} harinas para tu pan personalizado. El precio de esta sección es fijo: ${fixedHarinaPrice.toFixed(2)}.
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="text-center">
                ...
                {/* No mostrar precio individual de harina aquí */}
              </div>
            </motion.div>
          );
        })}
