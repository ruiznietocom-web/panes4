                ...
                >
                    <div className="relative w-32 h-auto md:w-48 md:h-64">
                        <motion.div
                            ...
                            className="absolute -top-12 -right-10 bg-white p-2 rounded-2xl rounded-bl-none shadow-lg border-2 border-green-600"
                        >
                            <p className="text-xs font-bold text-green-700 whitespace-nowrap">¡Ayudando a Santa! 🧝‍♂️</p>
                        </motion.div>
